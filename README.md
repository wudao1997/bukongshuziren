...
开源代码仓库不包含编译后的安装包和本地大模型文件。如需直接使用桌面端程序或离线 AI 能力，可通过以下网盘下载：

| 网盘 | 链接 | 提取码 |
|------|------|--------|
| 百度网盘 | https://pan.baidu.com/s/19X0xtCJtyD5hG3z-eVd0Jw | a92e |
| 夸克网盘 | https://pan.quark.cn/s/616c8ced1e30 | npfW |

网盘内容包含：

- Windows 桌面端安装包（.exe）
- 本地大模型文件（用于离线 AI 推理，开源代码中未包含）

> 注意：本地大模型文件体积较大，请确保磁盘空间充足。下载后将模型文件放置到软件设置中指定的模型目录即可使用离线功能。
